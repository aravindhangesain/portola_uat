...
router.register(r'document_template',views.DocumentTemplateViewSet)
router.register(r'project_template',views.ProjectTemplateViewSet)
router.register(r'entity_template',views.EntityTemplateViewSet)
